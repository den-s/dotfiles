...
alias docker_cleanup='docker rmi $(docker images -f "dangling=true" -q) && docker builder prune'

# set -xg PYTHONPATH /opt/homebrew/lib/python3.9
set -xg PYTHONPATH /opt/homebrew/lib/python3.12
# set -xg PATH $PATH /opt/homebrew/lib/python3.9/site-packages
