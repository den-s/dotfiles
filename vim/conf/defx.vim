...
function! s:defx_init()
  ...
  nnoremap <silent><buffer><expr> yy
        \ defx#do_action('call', 'DefxYankPath')
  nnoremap <silent><buffer><expr> .
        \ defx#do_action('toggle_ignored_files')
  nnoremap <silent><buffer><expr> ~
        \ defx#do_action('cd', '/Users/den/prj/')
...
function! SetRoot(_)
  call defx#call_action('cd', defx#get_candidate()['action__path'])
endfunction
...
nnoremap <leader>nn :Defx -split=vertical -winwidth=35 -direction=topleft -search=`expand('%:p')`<CR>
